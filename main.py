...
from controllers import auth_controller, user_controller, tenant_controller, owner_controller, admin_controller, role_controller, category_controller, property_controller, location_controller
