...
from controllers import auth_controller, user_controller, tenant_controller, owner_controller, admin_controller, role_controller, category_controller, property_controller, location_controller, property_file_controller, favourite_property_controller
...
api_router.include_router(favourite_property_controller.router)
